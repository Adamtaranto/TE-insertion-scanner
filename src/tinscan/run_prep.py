...
def mainArgs():
    parser = argparse.ArgumentParser(
        description="Split multifasta genome files into directories for A and B genomes.",
        prog="tinscan-prep",
    )
    # Input options
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Multifasta containing A genome.",
    )
    parser.add_argument(
        "-B", "--query", type=str, required=True, help="Multifasta containing B genome."
    )
    # Output options
    parser.add_argument(
        "--adir", type=str, default=None, help="A genome sub-directory within outdir"
    )
    parser.add_argument(
        "--bdir", type=str, default=None, help="B genome sub-directory within outdir"
    )
    parser.add_argument(
        "-d",
        "--outdir",
        type=str,
        default=None,
        help="Write split directories within this directory. (Default: cwd)",
    )
